...
namespace FarmSystem.Test1
{
    internal class Program
    {
        ...
        private static EmydexFarmSystem factoryClass()
        {
...
********************************************************************************************************************/
        private static void Excercise4()
        {
            ...
            var farm = factoryClass();
            farm.EventHandler += Farm_ProcessCompleted;
            farm.ReleaseAllAnimals();
            
            Console.ReadKey();
        }

        private static void Farm_ProcessCompleted(object sender, EventArgs e)
        {
